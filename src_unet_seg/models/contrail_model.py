...
#     def __init__(self, cfg, deepsupervision=False, clfhead=False, clf_threshold=0.5):
#         super().__init__()
#         # h,w = resolution
#         h,w = cfg.dataset.img_height, cfg.dataset.img_width
...
#         #encoder
#         model_name = cfg.architecture.backbone
#         if cfg.architecture.pretrained:
#             seresnext101 = pretrainedmodels.__dict__[model_name](pretrained=cfg.architecture.default_weight)
#         else:
...
# def build_model(cfg, model_name, deepsupervision, clfhead, clf_threshold):
#     if model_name=='seresnext101':
#         model = UNET_SERESNEXT101(cfg, deepsupervision, clfhead, clf_threshold)
#     return model
...
class Timm_Unet(nn.Module):
    def __init__(self, cfg, decoder_filters=[32, 48, 64, 96, 128, 256], **kwargs):
